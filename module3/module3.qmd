...
ssh  user1@159.65.95.44
# OR 
ssh  user2@159.65.95.44
```
...
mkdir /workshop/<username>/results
```
...
mkdir /workshop/<username>/scripts
```
...
bash /workshop/<username>/scripts/assembly.sh
```
...
scp user2@159.65.95.44:/workshop/user/results/quality_reports/qualifyr_report.tsv /path/to/local/machine
# OR 
scp user1@159.65.95.44:/workshop/user/results/quality_reports/qualifyr_report.tsv /path/to/local/machine
```

...
scp user2@159.65.95.44:results/quality_reports/qualifyr_report.tsv /path/to/local/machine
# OR 
scp user1@159.65.95.44:results/quality_reports/qualifyr_report.tsv /path/to/local/machine
```
